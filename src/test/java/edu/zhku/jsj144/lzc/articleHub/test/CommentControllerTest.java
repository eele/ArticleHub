...
public class CommentControllerTest {
	...
	public void testGetData() throws UnsupportedEncodingException, Exception {
		System.out.println(mockMvc.perform(MockMvcRequestBuilders.get("/user/username/12"))
				.andReturn()
				.getResponse()
				.getContentAsString());
	}
	...
	public void testDeleteData() throws UnsupportedEncodingException, Exception {
		System.out.println(mockMvc.perform(MockMvcRequestBuilders.delete("/user/username/12"))
				.andReturn()
				.getResponse()
				.getContentAsString());
	}
	...
	public void testInsertData() throws UnsupportedEncodingException, Exception {
		System.out.println(mockMvc.perform(MockMvcRequestBuilders
				.post("/user?uid=123&portraitURL=qwe&username=qwetext&password=qwetext&email=qwetext&desc=qwetext"))
				.andReturn()
				.getResponse()
				.getContentAsString());
	}
	...
	public void testUpdateData() throws UnsupportedEncodingException, Exception {
		System.out.println(mockMvc.perform(MockMvcRequestBuilders
				.put("/user/username/qwetext?uid=123&portraitURL=qwe&username=qwetext&password=123&email=qwetext&desc=qwetext"))
				.andReturn()
				.getResponse()
				.getContentAsString());
	}
